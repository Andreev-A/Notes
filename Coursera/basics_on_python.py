...
# копеек отбрасывается. Поэтому надо сделать - out * 100 % 100
# 17
# 94
# 41
# Ответ: 110 45.
# p, x, y = int(input()), int(input()), int(input())
# out = ((x * 100 + y) + (x * 100 + y) * p / 100) / 100
# print(int(out), int(out * 100 % 100))
