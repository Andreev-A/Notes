...
#                 self.speeds[p] = Vec2d(self.speeds[p].x, -self.speeds[p].y)
#
#     def draw_points(self, gameDisplay, points, style="points", width=3,
#                     color=(255, 255, 255)):
#         """отрисовка ломаной"""
#         if style == "line":
#             for p in range(-1, len(points) - 1):
#                 pygame.draw.line(gameDisplay, color, points[p].int_pair(),
...
#         hue = (hue + 1) % 360
#         color.hsla = (hue, 100, 50, 100)
#         knot.draw_points(gameDisplay, knot.points)
#         knot.draw_points(gameDisplay, knot.get_knot(steps), "line", 3, color)
#         if not pause:
#             knot.set_points()
#         if show_help:
#             knot.draw_help()
