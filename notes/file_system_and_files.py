...
# input_file = open('passwords.txt', 'r', encoding='utf-8')
# x = input_file.read()
# print(repr(x))
...
# with open('test.txt') as input_file, open('test-copy.txt', 'w') as w:
#     for line in input_file:
#         w.write(line)
...
# with open("examp.le", "w") as input_file:
# // работа с файлом
...
# with open("examp.le", "r") as input_file: # 'Hello, world!'
#     first_part = input_file.read(8)       # 'Hello, w'
#     input_file.seek(4)
#     second_part = input_file.read(8)      # 'o, world'
...
# with open("examp.le", "w") as input_file:
#     input_file.write(some_string_data)
...
# with open("examp.le", "w") as input_file:
#     input_file.writelines(list_of_strings)
...
# with open("examp.le", "w") as input_file:
#     print(some_data, file=input_file)
...
# with FileReadBackwards('file1.txt') as input_file, open('file2.txt','w') as w:
#     for line in input_file:
#         w.write(line+'\n_test')
...
#             break
# with open('D:\\main_ans.txt', 'w') as input_file:
...
# Функция join() модуля os.path в Python.
# Правильно соединить компоненты пути файловой системы.
# Синтаксис:
# import os.path
#
...
# конкатенацию пути path и компонентов *paths.
# Описание:
