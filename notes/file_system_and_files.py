...
# В результате у нас будет создан файл out.txt со строкой «Hello World!». Причем, этот файл будет располагаться в том же
# каталоге, что и файл с текстом программы на Python.
# Далее сделаем такую операцию: запишем метод write следующим образом:
# file.write("Hello")
# И снова выполним эту программу. Смотрите, в нашем файле out.txt прежнее содержимое исчезло и появилось новое – строка
